...
const skillCategories = [
  {
    ...
    icon: Brain,
    skills: [
      { name: "CNN & DNN Architectures", icon: Cpu },
      { name: "Pose Estimation", icon: Eye },
      { name: "Temporal Modelling", icon: Network },
      { name: "Computer Vision", icon: Eye },
      { name: "Model Evaluation Pipelines", icon: BarChart3 },
    ],
  },
  {
    title: "Programming",
    ...
    skills: [
      ...
      { name: "NumPy / Pandas", icon: Database },
      { name: "Git", icon: Boxes },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Power Apps", icon: Boxes },
      { name: "Power Automate", icon: Network },
